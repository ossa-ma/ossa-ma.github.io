...
![Double in action](/images/double_in_action.png)
_This just happened (5th Jan 2026), I noticed Claude about to create a project with some bs src and \_\_init\_\_.py stuff and I interrupted it to load my engineering preferences using the double command '/engineering' and voila, steered it in the right direction!_
...
That's it. Three markdown files. [See the full commands here](https://github.com/ossa-ma/double/tree/master/.claude/commands).
