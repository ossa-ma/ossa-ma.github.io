...
And the workflow is literally just three markdown files that tell Claude what to do:
...
That's it. Three markdown files. [See the full commands here](https://github.com/ossa-ma/double/tree/main/.claude/commands).
