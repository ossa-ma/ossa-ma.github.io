---
title: "Big Tech's Ugly Duckling: An Engineer's Bet on Snapchat"
...
_More important full disclosure: THIS IS NOT FINANCIAL ADVICE._
...
A first-party wallet means they can bypass platform fees entirely for in-app purchases, creator payouts, and digital goods.
More importantly, it creates a closed-loop economy where money stays on the platform.
Users load balances, spend within the ecosystem, Snap takes a cut (and potentially earns on float like PayPal).
...
_Shout out to Epic Games in their battle against the big Apple._
...
All the growth is coming from Rest of World, where ARPU is $1.11. Yeah... A dollar per user per quarter.
