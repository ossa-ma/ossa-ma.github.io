...
3. **Eliminating GroqCloud without inheriting Saudi contracts**: Nvidia has invested in other cloud providers (CoreWeave, brev.dev). GroqCloud was a competitor. Traditional acquisition would mean inheriting $1.5B worth of contracts to build AI infrastructure for Saudi Arabia, triggering CFIUS scrutiny. The carve out kills GroqCloud while avoiding geopolitical entanglement.
