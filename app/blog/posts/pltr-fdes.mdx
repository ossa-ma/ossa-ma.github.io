...
In 2021, I wrote a [university report](/documents/agile_and_palantir.pdf) on Agile software development. The assignment was to analyze how companies implement Agile methodologies. Most students picked the usual suspects—Spotify's squad model, Google's OKRs, Amazon's two-pizza teams.
...
*My full university report is available [here](/documents/agile_and_palantir.pdf) if you want to read the deep dive into Palantir's approach to Agile, team structure, and the FDE model.*