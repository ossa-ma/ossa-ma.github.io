...
I recently had a discussion with an engineer who defaults immediately to using Pydantic `BaseModel`s for everything, whether building a personal dashboard API or an enterprise system processing 50,000 requests/sec. 
...
If you have any alternatives, optimisation tips, tricks, better workflows, have identified any inaccuracies, any feedback on the blog post or want to say hello reach out to me here -> [ossamachaib.cs@gmail.com](mailto:ossamachaib.cs@gmail.com). 